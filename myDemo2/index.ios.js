    ...
    render: function(){
        return(
            <TabBarIOS style={styles.flex}>
                <TabBarIOS.Item
                    icon={require("./Snip20160917_1.png")}
                    title="消息"
                ...
                <TabBarIOS.Item
                    ...
                    <ScrollView style={styles.flex}>
                        <Image style={{width:width, height:height}}
                               source={{uri:'https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1474087927&di=dbecd48b0e9323dd96af74c236c8783c&src=http://www.thebigdata.cn/upload/2016-04/160411114854651.png'}}/>
                    </ScrollView>
                </TabBarIOS.Item>
            </TabBarIOS>
        );
...
AppRegistry.registerComponent('myDemo2', () => App);
